...
<section class="privacy_wrapper p_100 pt-0">
    <div class="container">
        <div class="">
            ...
            <h2>{{ optional($privacyPolicy)->title }}</h2>

            <div class="privacy_txt">
                @if(optional($privacyPolicy)->content)
                    {!! optional($privacyPolicy)->content !!}
                @endif
            <div>

                <!-- <div class="privacy_txt">
                    <p class="b_text">
                        This privacy notice discloses the privacy practices for <a href="cre8iveprinter.co.uk.">cre8iveprinter.co.uk.</a> This privacy notice applies solely to information collected by this web site. It will notify<br> you of the following:
                    </p>
                    <ul>
                        <li>
                            <img src="{{ asset('front/img/icons_1.svg')}}">
                ...
                <div class="privacy_txt">
                    <h5>Your consent</h5>
                    <p>
                        You acknowledge that this privacy policy is part of the terms of service and you agree that using this site signifies your consent to and agreement with Cre8ive Printer's privacy policy. Cre8ive Printer reserves the right to change the terms of service, including this privacy policy, at any time, without advanced notice. If we decide to change our privacy policy, we will post those changes on this page so you are always aware of what information we collect, how we use it, and under what circumstances we disclose it.
                    </p>
                </div>
                <div class="privacy_txt">
                    <h5>Your consent</h5>
                ...
                <hr>
                <div class="privacy_txt_bt">
                    <p>
                        If you feel that we are not abiding by this privacy policy,
                    </p>
                    <p>
                        contact us immediately via telephone at <a href="tel:{{ $home_content->phone ?? ''}}">{{ $home_content->phone ?? ''}}</a> or via email to <a href="mailto:{{ $home_content->email ?? ''}}">{{ $home_content->email ?? ''}}</a>
                    </p>
                </div> -->
            </div>
        </div>
