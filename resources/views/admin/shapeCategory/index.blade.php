...
<div class="card card-bordered card-preview d-none" id="addnewcard">
    <div class="card-inner">
        <div class="preview-block">
            <div class="d-flex justify-content-between">
                <span class="preview-title-lg overline-title">Add Shape Category</span>
...
$(document).ready(function(){
    ...
    $("body").delegate(".add", "click", function(e) {
        ...
        $.ajax({
            method: 'POST',
            url: '{{ url('admin-dashboard/shape-category/save') }}',
            dataType: 'json',
            data: {
                    name : name,
                    slug : slug,
...
$(document).ready(function() {
    ...
    $("body").delegate(".remove-category", "click", function (e) {
            ...
            $.ajax({
            method: 'POST',
            url: '{{ url('admin-dashboard/shape-category/remove') }}',
            dataType: 'json',
            data: {
                    id : id,
                    _token: '{{csrf_token()}}'
