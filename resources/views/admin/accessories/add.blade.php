...
@section('content')
    ...
    <div class="card card-bordered h-100">
        <div class="card-inner">
            ...
            <form action="{{ url('admin-dashboard/add-accessories-procc') }}" method="POST" enctype="multipart/form-data">
                <div class="row ">
                    <div class="col-lg-12">
                        @csrf
                        ...
                        <div class="col-lg-12 p-3 d-flex ">
                            ...
                            <div id="default_price" class="col-lg-4" style="padding-left: 1.5rem">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap ">
                                        <input type="text" name="default_price" id="price" class="form-control"
                                                                        ...
                                                                        @if ($variation->variationData !== null)
                                                                            @foreach ($variation->variationData as $data)
                                                                                <div id="input_div"
                                                                                    ...
                                                                                    <div class="col-lg-3 p-2">
                                                                                        <div class="form-group">
                                                                                            <i style="cursor: pointer" onclick="remove_variation_data(this,{{ $data->id ?? '' }})"
