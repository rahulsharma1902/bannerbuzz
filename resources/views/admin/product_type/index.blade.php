    ...
    <div class="card card-bordered card-preview d-none" id="addnewcard">
        <div class="card-inner">
            <div class="preview-block">
                <div class="d-flex justify-content-between">
                    <span class="preview-title-lg overline-title">Add Product Type</span>
                    <span class="close"><i class="fas fa-times"></i></span>
                </div>
                <div class="row gy-4">
                    <div class="col-sm-6">
                        <form action="{{ url('admin-dashboard/product-type-addProcc') }}" method="POST" id="form-data">
                            @csrf
                                ...
                                <div class="dropdown drop">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-xs">
                                        <ul class="link-list-plain">
                                            ...
                                            <li><a href="{{ url('admin-dashboard/product-type-remove/'.$type->id) }}" data-id ="{{ $type->id ?? '' }}"
