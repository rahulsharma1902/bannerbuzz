                        ...
                        <td class="nk-tb-col">
                            <div class="user-card">
                                <div class="user-avatar bg-dark d-none d-sm-flex">
                                    <img src="{{ asset('ClipArtImage')}}/{{ $clipart->image ?? '' }}"
                                        alt="{{ $clipart->slug ?? '' }}">
                                </div>
                                <div class="user-info">
                                    <span class="tb-lead">{{ $clipart->name ?? '' }}</span>

                                </div>
                            </div>
                        </td>
                        <td class="nk-tb-col tb-col-mb">
                            <span class="tb-amount">{{ $clipart->slug ?? '' }}</span>
                        </td>

                        <td class="nk-tb-col tb-col-md">
                            <span class="tb-amount">{{ $clipart->category->name ?? '' }}</span>
                        </td>
                                    ...
                                    <div class="drodown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <ul class="link-list-opt no-bdr">
                                                <li><a
                                                        href="{{ url('admin-dashboard/clipart-edit') ?? '' }}/{{ $clipart->slug ?? ''}}"><em
                                                            class="icon ni ni-eye"></em><span>Edit</span></a></li>
                                                <li><a class="delete"
                                                        link="{{ url('admin-dashboard/clipart-remove') ?? '' }}/{{ $clipart->slug ?? ''}}"><em
